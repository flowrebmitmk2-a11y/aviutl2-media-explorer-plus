...
$zipPath = Join-Path $releaseRoot "MediaExplorerPlus-v$Version.au2pkg.zip"
$artifactPath = Join-Path $repoRoot "build\\Release\\MediaExplorerPlus.aux2"
...
Copy-Item -LiteralPath $artifactPath -Destination (Join-Path $pluginRoot "MediaExplorerPlus.aux2") -Force
